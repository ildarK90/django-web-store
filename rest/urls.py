...
urlpatterns = [
    path('products_list/<str:model>', ProductList.as_view()),
    path('products/<str:model>',GeneralViewSet.as_view({'get':'list'})),
    path('myview/<str:model>',GeneralViewSet.as_view({'get':'list'})),
