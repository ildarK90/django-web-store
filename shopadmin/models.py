...
class TestModel(models.Model):
    ...
    slug = models.SlugField(max_length=255, db_index=True, verbose_name='URL',blank=True,null=True)
    photo = models.ImageField(upload_to='testmodel', blank=True,verbose_name='фото товара')
